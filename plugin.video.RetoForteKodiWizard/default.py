...
ADDON=xbmcaddon.Addon(id='plugin.video.RetoForteKodiWizard')
dialog = xbmcgui.Dialog()    
VERSION = "1.0.0"
PATH = "RetoForteKodiWizard"            

    
def CATEGORIES():
    link = OPEN_URL('https://retoforte.000webhostapp.com/Build/Wizard/wizard.html').replace('\n','').replace('\r','')
